...
# ==============================================================================
"""Tests for object_detection.precision_recall."""
...
class MetricsTest(tf.test.TestCase):
  ...
  def test_compute_cor_loc(self):
    ...
    corloc = precision_recall.compute_cor_loc(num_gt_imgs_per_class,
  ...
  def test_compute_precision_recall(self):
    ...
    precision, recall = precision_recall.compute_precision_recall(scores, labels, num_gt)
    precision_float_type, recall_float_type = precision_recall.compute_precision_recall(
  ...
  def test_compute_precision_recall_float(self):
    ...
    precision, recall = precision_recall.compute_precision_recall(
  ...
  def test_compute_average_precision(self):
    ...
    mean_ap = precision_recall.compute_average_precision(precision, recall)
  ...
  def test_compute_precision_recall_and_ap_no_groundtruth(self):
    ...
    ap = precision_recall.compute_average_precision(precision, recall)
  ...
  def test_compute_recall_at_k(self):
    ...
    recall_1 = precision_recall.compute_recall_at_k(tp_fp, num_gt, 1)
    recall_3 = precision_recall.compute_recall_at_k(tp_fp, num_gt, 3)
    recall_5 = precision_recall.compute_recall_at_k(tp_fp, num_gt, 5)

    recall_3_bool = precision_recall.compute_recall_at_k(tp_fp_bool, num_gt, 3)
  ...
  def test_compute_median_rank_at_k(self):
    ...
    median_ranks_1 = precision_recall.compute_median_rank_at_k(tp_fp, 1)
    median_ranks_3 = precision_recall.compute_median_rank_at_k(tp_fp, 3)
    median_ranks_5 = precision_recall.compute_median_rank_at_k(tp_fp, 5)
    median_ranks_3_bool = precision_recall.compute_median_rank_at_k(tp_fp_bool, 3)
